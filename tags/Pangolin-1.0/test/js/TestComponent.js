...
new Test.Unit.Runner({
    ...
    testWrongArgument: function() {
        this.assertRaise(null, function() {
            new A();
        });
    ...
    testExtension: function() {
        jPlex.provide('A.A', 'jplex.common.Component', {
            _definition: {
                name: 'A',
                defaultConfig: {
                    duck: 'quack',
        ...
        var B = jPlex.provide('A.B', 'A.A', {
            _extension: {
                defaultConfig: {duck: 'coin'}
            },
            initialize: function($super, eElement, oConfig) {
                $super(eElement, oConfig);
            }
        ...
        var b = new A.B('asd');
        this.assertEqual(b.cfg('duck'), 'coin');
        this.assertEqual(b.cfg('bird'), 'cui');
        this.assertEqual($('asd').nodeName.toLowerCase(), 'div');
    }
});
