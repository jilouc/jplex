 ...
 * @param {MenuBar.Item} oParent the parent item of the submenu
 ...
 * @private
 */
jPlex.provide('jplex.components.menubar.Submenu', {
    /**
     * Array of submenu items
     * @property oItems
     * @type Array<MenuBar.Item>
     * @see MenuBar.Item
     */
    ...
    addItem: function(oItem, nBefore) {
        var item = new jplex.components.menubar.Item(this, oItem, this.nLevel + 1);
        if (nBefore) {
